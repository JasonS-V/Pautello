...
- **Figuras Musicales:** Redonda (1), Blanca (2), Negra (3), Corchea (4), Semicorchea (5).
...
| **1, 2, 3, 4, 5** | Seleccionar duración (Redonda, Blanca, Negra, Corchea, Semicorchea) |
...
- Enlaces para donaciones voluntarias (Cafecito, Ko-fi, GitHub Sponsors).
